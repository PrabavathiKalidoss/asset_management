...
import '../services/shared/environment_service.dart';
              ...
              content: Container(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    Text(request.title  ?? '', textScaleFactor: 1, style: AppTextStyle.heading1Medium,),

                    VerticalSpacing.d20px(),

                    Text(request.description  ?? '', textAlign: TextAlign.center, textScaleFactor: 1, style: AppTextStyle.heading1Medium,),
                    ...
                    request.secondaryButtonTitle != null ? MaterialButton(onPressed: (){
                      _dialogService.dialogComplete(AlertResponse(status: false));
                    }, child: Text(request.secondaryButtonTitle ?? '', textScaleFactor: 1, style: AppTextStyle.button1.copyWith(color: AppColor.primary),)) : Container()
                      ...
                      Expanded(
                          child: request.title == null ? Container() : Padding(
                            ...
                            child: Text(request.title ?? '', textScaleFactor: 1,
                              style: AppTextStyle.heading1Medium.copyWith(fontSize: 17,),
                            ),
                          )
                      ),
